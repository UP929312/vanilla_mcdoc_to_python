...
class GeodeBlockSettings:
    ...
    cannot_replace: str | list[str]  # Blocks that will not be replaced by the geode.
    invalid_blocks: str | list[str]  # When encountering an invalid block, feature placement is cancelled.

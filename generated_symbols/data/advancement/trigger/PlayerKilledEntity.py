"""
Generated from symbols.json for ::java::data::advancement::trigger::PlayerKilledEntity
Local link to file: generated_symbols/data/advancement/trigger/PlayerKilledEntity.py
"""
# ~~~ CODE ~~~
...
class PlayerKilledEntity(TriggerBase):

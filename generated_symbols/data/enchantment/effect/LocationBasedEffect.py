...
@dataclass(kw_only=True)
class LocationBasedEffectApplyMobEffect:
...
@dataclass(kw_only=True)
class LocationBasedEffectChangeItemDamage:
...
@dataclass(kw_only=True)
class LocationBasedEffectDamageEntity:
...
@dataclass(kw_only=True)
class LocationBasedEffectReplaceBlock:
...
@dataclass(kw_only=True)
class LocationBasedEffectSpawnParticles:
...
@dataclass(kw_only=True)
class LocationBasedEffectSummonEntity:

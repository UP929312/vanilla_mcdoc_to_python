...
class DisplayBase(EntityBase):
    ...
    shadow_radius: Annotated[float, 'Range | `0` and above | inclusive'] | None = None  # Size of shadow. Defaults to 0 (no shadow). Interpolated.
    ...
    interpolation_duration: Annotated[int, 'Range | `0` and above | inclusive'] | None = None  # Ticks the interpolation should take to complete.
    ...
    view_range: Annotated[float, 'Range | `0` and above | inclusive'] | None = None  # Maximum view range of this entity. Actual distance depends on client-side render distance and entity distance scaling. Default value 1.0 (roughly the same as fireball).
    width: Annotated[float, 'Range | `0` and above | inclusive'] | None = None  # Describe width of the culling bounding box.  Bounding box spans vertically from y to y+height and horizontally width/2 in all directions from the entity position.  If set to 0, culling is disabled. Defaults to 0.
    height: Annotated[float, 'Range | `0` and above | inclusive'] | None = None  # Describes height of the culling bounding box.  Bounding box spans vertically from y to y+height and horizontally width/2 in all directions from the entity position.  If set to 0, culling is disabled. Defaults to 0.
